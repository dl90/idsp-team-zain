...
class Scene_5 extends Phaser.Scene {
  ...
  preload() {
    ...
    this.load.video('grocery_1', '/assets/video/theme_3_store/grocery_1.mp4');
    this.load.video('grocery_2', '/assets/video/theme_3_store/grocery_2.mp4');
    this.load.video('grocery_3', '/assets/video/theme_3_store/grocery_3.mp4');
  ...
  create() {
    ...
    const introMask = this.add.rectangle(
      ...
      story_1 = this.add.video(0, 0, 'grocery_1'),
      story_2 = this.add.video(0, 0, 'grocery_2'),
      story_3 = this.add.video(0, 0, 'grocery_3'),
