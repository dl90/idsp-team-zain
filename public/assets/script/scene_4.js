...
class Scene_4 extends Phaser.Scene {
  ...
  preload() {
    ...
    // tilemap and tileset
    this.load.image('level_4_background', '/assets/tileset/white_floor.png');
    this.load.image('level_4_tileset', '/assets/tileset/Office_Tileset.png');
    this.load.image('things', '/assets/tileset/things.png');
    this.load.tilemapTiledJSON('level_4', '/assets/tilemaps/level_4.json');
  }
  ...
  create() {
    ...
    // ------ map ------ //
    const map = this.add.tilemap('level_4'),
      background = map.addTilesetImage('background', 'level_4_background'),
      tileset = map.addTilesetImage('tileset', 'level_4_tileset'),
