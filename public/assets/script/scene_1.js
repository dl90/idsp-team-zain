...
class Scene_1 extends Phaser.Scene {
  ...
  preload() {
    ...
    // story element
    this.load.video('park_1', '/assets/video/theme_1_park/park1_1.mp4');
    this.load.video('park_2', '/assets/video/theme_1_park/park1_2.mp4');
    this.load.video('park_3', '/assets/video/theme_1_park/park1_3.mp4');
    this.load.video('park_4', '/assets/video/theme_1_park/park1_4.mp4');
    this.load.video('park_5', '/assets/video/theme_1_park/park1_5.mp4');
  ...
  create() {
    ...
    const introMask = this.add.rectangle(
      ...
      story_1 = this.add.video(0, 0, 'park_1'),
      story_2 = this.add.video(0, 0, 'park_2'),
      story_3 = this.add.video(0, 0, 'park_3'),
      story_4 = this.add.video(0, 0, 'park_4'),
      story_5 = this.add.video(0, 0, 'park_5'),
    ...
    let [story_arr, i] = [[story_1, story_2, story_3, story_4, story_5], 1];
